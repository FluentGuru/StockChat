...
namespace Jobsity.StockChat.Domain.Services
{
    ...
    {
        Task AddAsync<T>(params T[] entity) where T : class, IEntity, new();
    ...
    {
        public async static Task AddAndSaveAsync<T>(this IPersistence persistence, params T[] entity) where T : class, IEntity, new()
        {
